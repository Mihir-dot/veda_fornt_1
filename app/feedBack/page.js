          ...
          <>
            ...
            <div>
              ...
              <section className="contact-style-two sec-pad">
                <h4 className="text-center" style={{ color: "#6f42c1" }}><b>Vida Feedback Form</b></h4>
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 content-column">
                      <div className="content-box mr_70">
                        <div className="sec-title mb_35">
                          ...
                          <p className="mt_20">
                            Use this form to send Vida a complaint, compliment or feedback.
                            Our Quality Improvement Team will review any feedback received
                            and provide a response if required.
                          </p>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="row clearfix">
                            ...
                            <div className="col-lg-8 col-md-8 col-sm-8 form-group">
                              <input
                                ...
                                required
                              />
                              <span>To receive correspondence regarding this feedback please provide an email address.</span>
                            </div>
