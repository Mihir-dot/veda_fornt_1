                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 footer-column">
                                <div className="links-widget footer-widget ml_50">
                                    ...
                                    <div className="row mt-5">
                                        <div className="col-2">
                                            <Link href="https://www.facebook.com" style={{ display: 'inline-block', width: '40px', height: '40px', lineHeight: '40px', borderRadius: '50%', textAlign: 'center', color: '#000', backgroundColor: '#fff', border: '1px solid gray', transition: 'all 0.3s ease', margin: '0 auto' }}>
                                                <i className="fab fa-facebook-f"></i>
                                            </Link>
                                        </div>
                                        <div className="col-2 text-center">
                                        <Link href="https://twitter.com/" style={{ display: 'inline-block', width: '40px', height: '40px', lineHeight: '40px', borderRadius: '50%', textAlign: 'center', color: '#000', background: '#fff', border: '1px solid gray', transition: 'all 0.3s ease', margin: '0 auto' }}>
                                            <i className="fab fa-twitter"></i>
                                        </Link>
                                    </div>
                                        <div className="col-2 text-center">
                                            <Link href="https://www.linkedin.com/" style={{ display: 'inline-block', width: '40px', height: '40px', lineHeight: '40px', borderRadius: '50%', textAlign: 'center', color: '#000', backgroundColor: '#fff', border: '1px solid gray', transition: 'all 0.3s ease', margin: '0 auto' }}>
                                        ...
                                        <div className="col-2 text-center">
                                            <Link href="https://www.youtube.com/" style={{ display: 'inline-block', width: '40px', height: '40px', lineHeight: '40px', borderRadius: '50%', textAlign: 'center', color: '#000', background: '#fff', border: '1px solid gray', transition: 'all 0.3s ease', margin: '0 auto' }}>
